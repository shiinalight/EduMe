...
export function buildTutorPayload({ sessionId, worksheet, question, attempts, includeInk = true }) {
  return {
    ...
    question: question ? { id: question.id, label: question.label, text: question.text, latex: question.latex, diagram_description: question.diagram_description || '', ambiguities: question.ambiguities || [], reviewed: question.reviewed === true, ...(question.origin ? { origin: question.origin } : {}), ...(question.voice ? { voice: question.voice } : {}) } : null,
